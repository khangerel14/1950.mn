      ...
      <div className="flex max-w-screen-xl mx-auto items-center h-20 justify-between">
        ...
        <div className="flex gap-8 items-center">
          <button
            ...
            style={{ color: name === "/introduction" ? "#1D4ED8" : "" }}
            onClick={intro}
          >
            Танилцуулга
          </button>
          <button
            className="hover:text-[#1D4ED8] font-medium text-white"
            style={{ color: name === "/opportunity" ? "#1D4ED8" : "" }}
            onClick={oppor}
          >
            Боломжууд
          </button>
          <button
            className="hover:text-[#1D4ED8] font-medium text-white"
            style={{ color: name === "/getInTouch" ? "#1D4ED8" : "" }}
            onClick={getInTouch}
          >
            Холбоо барих
          </button>
        ...
        <div>
          <button
            className="px-4 py-2 bg-[#1D4ED8] rounded-lg text-white text-sm font-medium"
            onClick={driverCV}
          >
            Жолооч болох ?
          </button>
